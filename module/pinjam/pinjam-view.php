    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="module/pinjam/aksi.php?module=peminjaman&act=insert" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="siswa" class="form-select">
                          ...
                          $conn = (mysqli_query($connection, $query));
                          while  ($data = mysqli_fetch_array($conn)) { ?>
                          <option value="<?= $data['nisn'];?>"> <?= $data['judul_buku']; ?> </option>
                          <?php } ?>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label for="tanggalKembali" class="form-label">Tanggal Pengembalian (3 Hari Kerja)</label>
                        <input type="date" name="judul_buku" class="form-control" required>
                    </div>
